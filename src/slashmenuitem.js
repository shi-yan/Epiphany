...
class CodeEditorItem extends SlashMenuItem {
    constructor(icon, title, subtitle, shortcut) {
        ...
        let secondaryElm = document.createElement('div');
        secondaryElm.style.display = 'flex';
        secondaryElm.style.flexDirection = 'column';

        let div1 = document.createElement('div');
        div1.innerText = "language 1";

        let div2 = document.createElement('div');
        div2.innerText = "language 2";

        secondaryElm.appendChild(div1);
        secondaryElm.appendChild(div2);
    }
